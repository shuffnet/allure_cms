<nav class="navbar navbar-default">
    ...
    <a href="{{route('jobsSessions.index', ['jobID'=>$job->id])}}" class="btn btn-link navbar-btn">Sessions <span class="badge">{{count($job->sessions)}}</span></a>
    ...
    <a href="{{route('job.files', ['jobID'=>$job->id])}}">Files</a>
